...
<!-- AGENT ROUTING PROTOCOL
     1. Read this file FIRST — do not load any SKILL.md yet.
     2. Match the user's request against the Trigger column below.
     3. Load ONLY the matched skill's SKILL.md.
     4. Follow its Process steps exactly.
     If no skill matches, respond directly without loading any SKILL.md.
-->

| Skill | Trigger Keywords / Phrases | SKILL.md Path |
|-------|---------------------------|---------------|
